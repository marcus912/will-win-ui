            ...
            <SubCard title="Skills">
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <LinearProgressWithLabel color="primary" variant="determinate" value={80} aria-label="Researcher skill progress" />
                </Grid>
                <Grid item xs={12} md={6}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <LinearProgressWithLabel color="primary" variant="determinate" value={80} aria-label="Graphic skill progress" />
                </Grid>
                <Grid item xs={12} md={6}>
