...
const Customer = Loadable(lazy(() => import('views/basic-setting/customer/CustomerPage')));
const Form = Loadable(lazy(() => import('views/basic-setting/form/form')));
